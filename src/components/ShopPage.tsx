...
const categories: Record<string, { label: string; slugs: string[] }> = {
  ...
  'steel-cable-ties': { label: 'Stainless Steel Cable Ties', slugs: ['ss-4-6-150mm','ss-4-6-200mm','ss-4-6-250mm','ss-4-6-300mm','ss-4-6-350mm','ss-4-6-400mm','ss-4-6-450mm','ss-4-6-500mm','ss-4-6-550mm','ss-4-6-600mm','ss-7-9-200mm','ss-7-9-250mm','ss-7-9-300mm','ss-7-9-350mm','ss-7-9-400mm','ss-7-9-450mm','ss-7-9-500mm','ss-7-9-550mm','ss-7-9-600mm','ss-7-9-650mm','ss-7-9-700mm','ss-7-9-750mm','ss-7-9-800mm'] },
  'installation-tools': { label: 'Installation Tools', slugs: ['ss-installation-tool'] },
