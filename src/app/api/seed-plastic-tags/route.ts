...
const PRODUCTS = [
  ...
  ["Tag 62 x 125mm", "tag-62x125", "Unprinted plastic tag 62 x 125 mm. Sold per 1000. Colours: Clear, White, Yellow, Orange, Red, Pink, Lilac, Blue, Green, Silver, Florescent Yellow, Magenta. Contact sales for printing options.", "Plastic tags", 1790.0, "Per 1000", 1000, 100, "/assets/62x100.png"],
  ["Tag 62 x 150mm", "tag-62x150", "Unprinted plastic tag 62 x 150 mm. Sold per 1000. Colours: Clear, White, Yellow, Orange, Red, Pink, Lilac, Blue, Green, Silver, Florescent Yellow, Magenta. Contact sales for printing options.", "Plastic tags", 2010.0, "Per 1000", 1000, 100, "/assets/62x150mm.png"],
