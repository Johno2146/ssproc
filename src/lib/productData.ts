...
export const productSpecs: Record<string, ProductSpec> = {
  ...
  'ct-100mm': { material: 'PA66 (Nylon 6/6)', pullStrength: '8.2kg', dimensions: '100 × 2.5 × 1.1 mm', colours: ['White', 'Red', 'Blue', 'Green', 'Yellow', 'Orange', 'Purple', 'Pink', 'Brown', 'Navy', 'Lime', 'Silver'], applications: ['Cable management', 'General purpose'], features: ['UV resistant'], securityLevel: 'Standard', boxSize: '45 × 30 × 30 cm', weightKg: 0.03, lengthCm: 10, widthCm: 10, heightCm: 2 },
  'ct-150mm': { material: 'PA66 (Nylon 6/6)', pullStrength: '13.6kg', dimensions: '150 × 3.6 × 1.3 mm', colours: ['White', 'Red', 'Blue', 'Green', 'Yellow', 'Orange', 'Purple', 'Pink', 'Brown', 'Navy', 'Lime', 'Silver'], applications: ['Cable management', 'General purpose'], features: ['UV resistant'], securityLevel: 'Standard', boxSize: '45 × 30 × 30 cm', weightKg: 0.07, lengthCm: 15, widthCm: 10, heightCm: 2 },
  'ct-200mm': { material: 'PA66 (Nylon 6/6)', pullStrength: '22.7kg', dimensions: '200 × 4.8 × 1.3 mm', colours: ['White', 'Red', 'Blue', 'Green', 'Yellow', 'Orange', 'Purple', 'Pink', 'Brown', 'Navy', 'Lime', 'Silver'], applications: ['Cable management', 'General purpose'], features: ['UV resistant'], securityLevel: 'Standard', boxSize: '45 × 30 × 30 cm', weightKg: 0.13, lengthCm: 20, widthCm: 10, heightCm: 4 },
